...
def model_evaluation(model, test_data, tokenizer, slot_meta, epoch, op_code='4',
    ...
    for di, i in enumerate(test_data):
        ...
        #d_gold_op, generate_y, gold_state = make_turn_label(slot_meta, last_dialog_state, gold_state,
        ...
        #print(f'predict: {pred_state}') prediction is empty list
    ...
    print("-----------------------------\n")
    json.dump(results, open('preds_%d.json' % epoch, 'w'), indent=2, ensure_ascii=False)
