...
if __name__ == "__main__":
    ...
    parser.add_argument("--warmup_ratio", type=int, default=0)
    ...
    parser.add_argument("--hidden_dropout_prob", type=float, default=0.1) # default was 0.1
    ...
    # Data Loading
    train_data_file = f"{args.data_dir}/additional_dials.json"
    slot_meta = json.load(open(f"{args.data_dir}/slot_meta.json"))
    train_data = json.load(open(train_data_file))
    ...
    for epoch in range(n_epochs):
        ...
        torch.save(model.state_dict(), f"{args.model_dir}/add_model-{epoch}.bin")