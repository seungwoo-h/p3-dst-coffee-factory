import torch
from data_utils import DSTPreprocessor, convert_state_dict, OpenVocabDSTFeature
...
class TRADEPreprocessor(DSTPreprocessor):
    ...
    def _convert_example_to_feature(self, example):
        dialogue_context = f" {self.src_tokenizer.sep_token_id} ".join(example.context_turns + example.current_turn)
